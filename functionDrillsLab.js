...
let nameGreeting = nameCheck(`Maximus Decimus Meridius`)
...
function frogAllowance(gold){
  return Math.floor(gold / 3)
}
let totalFrogs = frogAllowance(120)
...
// I, uh... solved this bug on the first attempt above... "measure twice, cut once," am I right? xD
